  ...
  <div class="app-container">
    <el-form :inline="true">
      ...
      <el-form-item>
        ...
        <el-button
          v-permisaction="['system:menu:add']"
          type="primary"
          icon="el-icon-plus"
          size="mini"
          @click="handleAdd"
    ...
    >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
        <template slot-scope="scope">
          <el-button
            v-permisaction="['system:menu:edit']"
            size="mini"
            type="text"
            icon="el-icon-edit"
          ...
          >新增</el-button>
          <el-button
            v-permisaction="['system:menu:remove']"
            size="mini"
            type="text"
            icon="el-icon-delete"
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType === 'C' || form.menuType === 'M'" label="重定向" prop="redirect">
              <el-input v-model="form.redirect" placeholder="请输入重定向地址" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.menuType === 'M' || form.menuType === 'C'" label="菜单状态">
