<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-permisaction="['system:role:add']"
          type="primary"
          icon="el-icon-plus"
          size="mini"
          @click="handleAdd"
      ...
      <!-- <el-col :span="1.5">
        <el-button
          v-permisaction="['system:role:remove']"
          type="danger"
          icon="el-icon-delete"
          size="mini"
          :disabled="multiple"
...
<script>
import { listRole, getRole, delRole, addRole, updateRole, changeRoleStatus, roleDeptTreeselect } from '@/api/system/role'
