    ...
    <div>
      <div style="padding-top:20px;">
        ...
        <el-row class="row content-font-size">
          ...
          <el-col :span="5" class="info-item">原资产编号：<span class="value">{{ form.AssetNumber }}</span></el-col>
          <el-col :span="6" class="info-item">品牌： {{ form.Manufactory }}</el-col>
          <el-col :span="6" class="info-item">类型： {{ form.Type }}</el-col>
          <el-col :span="24" class="info-item">配置： {{ form.Configuration }}</el-col>
          <el-col :span="7" class="info-item">地区： {{ form.Region }}</el-col>
          <el-col :span="5" class="info-item">状态： {{ form.StatusValue }}</el-col>
          <el-col :span="6" class="info-item">领用人： {{ form.Recipient }}</el-col>
          <el-col :span="6" class="info-item">部门： {{ form.Department }}</el-col>
    ...
    <el-dialog title="编辑信息" :visible.sync="open" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="类型" prop="Type">
          <el-input v-model="form.Type" placeholder="笔记本电脑/台式电脑/显示器" />
        </el-form-item>
        ...
        <el-form-item label="状态">
          <el-select v-model="form.Status" clearable placeholder="请选择" class="el-input--small">
            <el-option
