...
var (
	...
	ErrForbidden = errors.New("没有权限，请联系系统管理员-孙楠杰")

	// ErrMissingUUID ..
	ErrMissingUUID = errors.New("请求失效，请重新登录")
	...
	ErrFailedAuthentication = errors.New("登录失败，请联系系统管理员")
	...
	// ErrInvalidVerificationode invalid verification code
	...
	// Name TODO: for yearning use
	Name = "name"
	// Role TODO: for yearning use
	Role = "role"
)
...
func (mw *GinJWTMiddleware) MiddlewareInit() error {
	...
	c := config.GetConfig()
	if c.GetInt("jwt.timeout") != 0 {
		mw.Timeout = time.Duration(c.GetInt("jwt.timeout")) * time.Hour
	}
